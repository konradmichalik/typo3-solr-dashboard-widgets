...
INSERT INTO sys_template
  (pid, tstamp, crdate, title, hidden, starttime, endtime, root, clear, include_static_file, constants, config, sorting, deleted)
VALUES
  (1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 'Solr Demo Root',
   0, 0, 0, 1, 3,
